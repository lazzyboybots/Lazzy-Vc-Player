...
MONGO_DB_URL = getenv("MONGO_DB_URL", "mongodb+srv://nshubh345:1FmseyW0TKaWNMNo@cluster0.pgewb.mongodb.net/?retryWrites=true&w=majority")
OWNER_NAME = getenv("OWNER_NAME", "Satoru Gojo")
OWNER_USERNAME = getenv("OWNER_USERNAME", "Satorux_Gono")
ALIVE_NAME = getenv("ALIVE_NAME", "Gojo")
BOT_USERNAME = getenv("BOT_USERNAME", "Lazzy_VCMusic_Bot")
OWNER_ID = getenv("OWNER_ID", "7743411008")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "Lazzy_Music_Boy")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "https://t.me/Lazzy_Bots_Support")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "https://t.me/Lazzy_Bots_Official")
